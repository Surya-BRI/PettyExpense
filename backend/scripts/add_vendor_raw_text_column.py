# Adds vendorRawText to ErpExpenseTransaction if missing (create_all() never ALTERs existing
# tables). Run: python scripts/add_vendor_raw_text_column.py — idempotent, safe to re-run.
# Equivalent raw SQL if you'd rather run it yourself:
#   ALTER TABLE dbo.ErpExpenseTransaction ADD vendorRawText NVARCHAR(256) NULL;
import sys
...
TABLE = "ErpExpenseTransaction"
COLUMNS = [
    ("vendorRawText", "NVARCHAR(256) NULL"),
]
